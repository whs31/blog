...
Это позволяет достичь **максимальной разрешающей способности** за счет длительного накопления сигнала, однако охват изображения ограничен поверхностью, захватываемой лучом диаграммы направленности антенны радара.
