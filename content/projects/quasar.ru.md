...
геопривязанные изображения или видеопотоки. Процесс представляет собо многоступенчатый конвейер.
...
- **Фокусировка**: компенсация фазовых ошибок на основе минимизации энтропии изображения
